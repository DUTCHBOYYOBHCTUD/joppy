...
const BeehiveModel = () => {
  ...
  return (
    <Center position={[0, -0.5, 0]}>
      {/* Scaled up massively based on feedback to fill more of the frame */}
      <primitive ref={meshRef} object={beehive.scene} scale={3.5} />
    </Center>
  );
};
...
const Beehive3D = () => {
  return (
    <div style={{ width: '100%', height: '100%', minHeight: '500px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <Canvas camera={{ position: [0, 2.5, 9], fov: 45 }} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'transparent' }}>
